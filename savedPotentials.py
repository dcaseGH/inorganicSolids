...
# LATP pots + BV (2nd V potential from glasses)
compositeBVGlassPotential1_240317 = [
                                     VBuckingham(species1 = Species(element = 'B'),
                                                 species2 = Species(element = 'O', core='shel'),
                                                 A        = 715.917969,
                                                 rho      = 0.298132,
...
#Potential2 doesn't get densities correct for tetrahedral vanadium oxide groups
NOTUSEDcompositeBVGlassPotential2_240317 = [
                                     VBuckingham(species1 = Species(element = 'B'),
                                                 species2 = Species(element = 'O', core='shel'),
                                                 A        = 715.917969,
                                                 rho      = 0.298132,
...
# these are reoptimised pots for glass, but don't use as better to have same LATP pots
NOTUSEDfinalBVGlassPotential310117 = [
                               VBuckingham(species1 = Species(element = 'B'),
                                           species2 = Species(element = 'O', core='shel'),
                                           A        = 715.917969,
                                           rho      = 0.298132,
